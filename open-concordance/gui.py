...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        ...
        #Vertical scrollbar
        self.output_window.xscrollbar = tk.Scrollbar(self.output_window, orient=tk.HORIZONTAL,
                                                     command=self.conc_output_area.xview)
    ...
    def concordance(self):
        ...
        for r in results:
            self.conc_output_area.insert(tk.END,
                                         "{0:>{lw}} <{1:^{ww}}> {2:<{rw}}    file ({3:<{pw}}).\n".format(r[1], r[0],
                                                                                                         r[2], r[3],
                                                                                                         lw=l_width,
                                                                                                         rw=r_width,
                                                                                                         ww=w_width,
